 ...
 *  Descriptor.
 */
const USB_Descriptor_String_t PROGMEM ProductString = USB_STRING_DESCRIPTOR(L"intiLED Controller");

const USB_Descriptor_String_t PROGMEM SerialString = USB_STRING_DESCRIPTOR(L"878007");
